...
@Injectable()
export class QlNotificationService {
  
  components: any[] = []
  
  constructor(
    @Optional() private root: QlNotificationContainer,
  ...
  createComponent(): void {
    const com: ComponentRef<any> = this.dynamic.generator(QlNotificationContainer)
