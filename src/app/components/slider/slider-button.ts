...
@Component({
  ...
  template: `
    <div class="ql-slider__button-wrapper"
      ...
      <div class="ql-slider__button ql-tooltip" #wrapper
        (mouseenter)="popperMouseHandle(true)" (mouseleave)="popperMouseHandle(false)"></div>
      <div class="ql-tooltip__popper is-dark popper-center" x-placement="top"
...
export class QlSliderButton implements OnInit, OnChanges {
  ...
  constructor(
    @Optional() private root: QlSlider,
